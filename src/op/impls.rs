...
impl OpCode {
    ...
    pub const fn decode(id: u8) -> Option<OpCode> {
        match id {
            ...
            6 => Some(OpCode::Remainder),
            7 => Some(OpCode::CountLeadingZeros),
            8 => Some(OpCode::CountLeadingOnes),
            9 => Some(OpCode::CountTrailingZeros),
            10 => Some(OpCode::CountTrailingOnes),
            11 => Some(OpCode::Jump),
            12 => Some(OpCode::JumpIfZero),
            13 => Some(OpCode::JumpIfEqual),
            14 => Some(OpCode::Call),
